package com.ge.tms.common.security;

import com.ge.tms.common.consts.RecordStatus;
import com.ge.tms.common.exception.AccountFrozenException;
import com.ge.tms.common.exception.AccountNotExistException;
import com.ge.tms.dao.AdminAccountRepository;
import com.ge.tms.entity.AdminAccount;
import com.ge.tms.mapper.AuthMapper;
...
/**
 * @author Nitin K.
 * Service Class to authenticate a user.
 */
@Service
@Primary
