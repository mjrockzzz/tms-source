...
@Entity
@Table(name = "tou_rates_history")
public class TOURatesHistory {

	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer touRateHistoryId;
	

	@Column(name = "tou_rate_id")
	...
	public Integer getTouRateHistoryId() {
		return touRateHistoryId;
	}


	public void setTouRateHistoryId(Integer touRateHistoryId) {
		this.touRateHistoryId = touRateHistoryId;
	}
