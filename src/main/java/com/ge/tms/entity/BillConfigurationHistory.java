...
@Entity
@Table(name = "bill_configuration_history")
public class BillConfigurationHistory {

	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer billConfigurationHistoryId;
	
	@Column(name = "bill_configuration_id")
	...
	public Integer getBillConfigurationHistoryId() {
		return billConfigurationHistoryId;
	}

	public void setBillConfigurationHistoryId(Integer billConfigurationHistoryId) {
		this.billConfigurationHistoryId = billConfigurationHistoryId;
	}
